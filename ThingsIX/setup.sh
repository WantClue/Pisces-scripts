...
function onboard() {
    ...
    if whiptail --yesno "You need to go into the WebUI of your Pisces Miner now and disable the forwarder. After that enable the forwarder again. Have you done so?" 14 60; then
